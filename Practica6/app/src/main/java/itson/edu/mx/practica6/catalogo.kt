...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas() {
        peliculas.add(Pelicula("Demon Slayer: Kimetsu no Yaiba -To the Hashira Training",
            R.drawable.demon, R.drawable.demo,
            "Demon Slayer: Kimetsu no Yaiba -To the Hashira Training- proyectará por primera vez en cines el " +
                    ...
                    "que se podrá ver por primera vez.", arrayListOf<Cliente>()
        ))
        peliculas.add(Pelicula(
            "Duna: Parte Dos",
            R.drawable.dune, R.drawable.dune2,
            "Duna: Parte Dos explorará el viaje mítico de Paul Atreides mientras se une con Chani y los " +
                    ...
                    "esfuerza por evitar un futuro terrible que solo él pueda prever.",arrayListOf<Cliente>()
        ))

        peliculas.add(Pelicula(
            "Ghostbusters Apocalipsis",
            R.drawable.ghostbusters, R.drawable.ghostbusters,
            "En Ghostbusters Apocalipsis Fantasma, regresa la familia Spengler a donde todo empezó – la " +
                    ...
                    "al mundo de una segunda era de hielo.",arrayListOf<Cliente>()
        ))

        peliculas.add(Pelicula(
            "Héroe Por Encargo",
            R.drawable.heroexencargo, R.drawable.heroeencargo,
            "Un ex agente de las fuerzas especiales acepta un trabajo para brindar seguridad a una periodista " +
                    "mientras entrevista a un dictador, pero estalla un golpe militar en medio de la entrevista y se ven " +
                    "obligados a escapar a la jungla donde deben sobrevivir.",arrayListOf<Cliente>()
        ))
        peliculas.add(Pelicula(
            "Vidas Pasadas",
            R.drawable.vidaspasadas, R.drawable.vidaspasadas1,
            "Nora y Hae Sung, dos amigos de la infancia profundamente unidos, son separados después de que" +
                    "la familia de Nora emigrara de Corea del Sur. Veinte años después, se reúnen durante una fatídica " +
                    "semana para enfrentarse al amor y al destino.",arrayListOf<Cliente>()
        ))

        peliculas.add(Pelicula(
            "Madame Web",
            R.drawable.madameweb, R.drawable.madame,
            "Mientras tanto, en otro universo… En un cambio del típico género, Madame Web cuenta la " +
                    ...
                    "si pueden sobrevivir a un presente mortal.",arrayListOf<Cliente>()
        ))
    ...
    fun cargarSeries() {
        series.add(
            Pelicula(
                ...
                R.drawable.ant, R.drawable.ant,
                "La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar" +
                        "el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la " +
                        "Nación del Fuego.",arrayListOf<Cliente>()
            )
        )
        ...
        series.add(
            Pelicula(
                ...
                "Una evacuación mortal cambia la guerra del Jefe Maestro con el Covenant. En Reach, un nuevo " +
                        "régimen toma el mando en FLEETCOM. John siente una amenaza inminente cerca. Estreno de " +
                        "temporada.",arrayListOf<Cliente>()
            )
        )
        ...
        series.add(
            Pelicula(
                ...
                "En un mundo en el que ciertos humanos llamados “cazadores” poseen habilidades mágicas, estos " +
                        ...
                        "sobrevivir.",arrayListOf<Cliente>()
            )
        )
        ...
        series.add(
            Pelicula(
                ...
                "Se centra en la vida de Jung Koo Won, un temerario demonio que pierde sus poderes tras conocer " +
                        "a Do Do-Hee, una exitosa empresaria con la que deberá de colaborar para recuperarlos.",arrayListOf<Cliente>()
            )
        )
        ...
        series.add(
            Pelicula(
                ...
                "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan " +
                        "por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.",arrayListOf<Cliente>()
            )
        )
        ...
        series.add(
            Pelicula(
                ...
                "Geralt de Rivia, un cazador de monstruos mutante, viaja en pos de su destino por un mundo " +
                        "turbulento en el que, a menudo, los humanos son peores que las bestias.",arrayListOf<Cliente>()
            )
        )
    }
}
...
class PeliculaAdapter : BaseAdapter {
    ...
    override fun getView(position: Int, p1: View?, p2: ViewGroup?): View {
        ...
        image.setOnClickListener {
            val intento = Intent(context, detalla_pelicula::class.java)
            intento.putExtra("nombre", pelicula.nombre)
